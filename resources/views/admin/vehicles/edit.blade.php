    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.vehicles.update', $vehicle->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="number_plate" name="number_plate" value="{{ $vehicle->number_plate }}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="driver_phone" name="driver_phone" value="{{ $vehicle->driver_phone }}" required>
            </div>
            <div class="form-group">
                <label for="background_photo">Background Photo</label>
                <input type="file" class="form-control" id="background_photo" name="background_photo" accept="image/*">
            </div>
